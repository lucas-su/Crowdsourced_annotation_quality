            ...
            for i in range(nSamples):
                ...
                for v in range(self.cardinality):
                    ...
                    for t, c in zip(ts, cs):
                        a[v] *= t if c else ((1. - t)/(self.car-1))  # todo put job on cluster for set with car-1 correction! Compute the probability that this combination of correctnesses happens
